...
const attackTypeData = [
  ...
  { name: 'Chain', description: 'Units attack jump between multiple Enemies.', icon: 'https://images.weserv.nl/?url=static.wikitide.net/fivenightstowerdefense2wiki/0/05/Attack_Type_Chain.png' },
  ...
  { name: 'Large Line AoE', description: 'Units attacks all enemies within a large line between them and the target.', icon: 'https://images.weserv.nl/?url=static.wikitide.net/fivenightstowerdefense2wiki/7/7b/Attack_Type_Large_Line_AoE.png' },
        ...
        <div className="h-[75vh] overflow-y-auto pr-2 space-y-6">
            <div className="bg-black/20 p-4 border border-border-dark">
                <p className="text-text-light">
                    Attack Types are classifiers on how Units attack. There are currently 14 Attack Types.
                </p>
            </div>
                    ...
                    <table className="stats-table">
                        ...
                        <tbody>
                            {attackTypeData.map((item, index) => (
                                <tr key={index}>
                                    <td className="p-2 font-pixel text-glow-purple align-top pt-3">{item.name}</td>
